    ...
    public partial class mtc01h36 : System.Web.UI.Page
    {
        ...
        protected void RadGrid1_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandType = CommandType.Text;
                cmd.Connection = con;
                cmd.CommandText = "delete mtc01h36 SET userid = @userid, lastupdate = GETDATE(), void = '4' WHERE (PM_id = @PM_id)";
        ...
        protected void cb_notif_PreRender(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "SELECT Notif_type FROM mtc00h21 WHERE Notif_type_name = '" + (sender as RadComboBox).Text + "'";
            SqlDataReader dr;
            dr = cmd.ExecuteReader();
            while (dr.Read())
                (sender as RadComboBox).SelectedValue = dr[0].ToString();
        ...
        protected void cb_status_PreRender(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "SELECT wo_status FROM mtc00h19 WHERE wo_desc = '" + (sender as RadComboBox).Text + "'";
            SqlDataReader dr;
            dr = cmd.ExecuteReader();
            while (dr.Read())
                (sender as RadComboBox).SelectedValue = dr[0].ToString();
