<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TelerikWebApplication.Form.Preventive_maintenance.Reports.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../../../Styles/common.css" rel="stylesheet" />
        <a href="http://localhost:55792/Form/Preventive_maintenance/Report/">http://localhost:55792/Form/Preventive_maintenance/Report/</a>
    ...
    <%--<select id="theme-switcher"></select>--%>
        ...
        <telerik:ReportViewer ID="ReportViewer1" runat="server"
            ...
            <ReportSource
                ...
                Identifier="ReportLibrary.Reports.Maintenance.ReportCatalog, ReportLibrary, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null">
            </ReportSource>
