namespace TelerikWebApplication.Form.Preventive_maintenance.MaterialRequest
{
    ...
    /// <summary>
    /// Summary description for inv01h02_slip.
    /// </summary>
    public partial class inv01h02_slip : Telerik.Reporting.Report
    {
        public static string _tr_code;

        public inv01h02_slip()
        {
            //
            ...
            sqlDataSource1.Parameters[0].Value = "=Parameters.sro_code.Value";
