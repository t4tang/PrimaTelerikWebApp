  <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mtc01h01EditForm.aspx.cs" Inherits="TelerikWebApplication.Form.Preventive_maintenance.DBCM.mtc01h01EditForm" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:UpdatePanel runat="server">
                                        ...
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="cb_reff" />
                                        </Triggers>
                                    </asp:UpdatePanel>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:UpdatePanel runat="server">
                                        ...
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="cb_reff" />
                                            <asp:AsyncPostBackTrigger ControlID="cb_unit" />
                                        </Triggers>
                                    </asp:UpdatePanel>
        ...
        <div style="padding: 5px 15px 10px 15px;">
            ...
            <telerik:RadMultiPage runat="server" ID="RadMultiPage2"  SelectedIndex="0" >
                            ...
                            <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid2" GridLines="None" AutoGenerateColumns="false" PageSize="3"  Skin="Silk"
                                ...
                                <MasterTableView CommandItemDisplay="Top" DataKeyNames="trans_id,status,down_date,down_time" Font-Size="11px" EditMode="InPlace"
                                    ...
                                    <Columns>
                                        ...
                                        <EditItemTemplate>
                                            <telerik:RadDatePicker runat="server" ID="trans_dateEdit" Width="120px" Skin="Silk"
                                                DbSelectedDate='<%#DataBinder.Eval(Container, "DataItem.down_date")%>'                                        
                                                onkeydown="blurTextBox(this, event)" Type="Date">
                                                <DateInput DisplayDateFormat="dd-MM-yyyy" runat="server" /> 
                                            </telerik:RadDatePicker>
                                        ...
                                        <InsertItemTemplate>
                                            <telerik:RadDatePicker runat="server" ID="trans_dateInsert" Width="120px" Skin="Silk"                                                                              
                                                onkeydown="blurTextBox(this, event)" Type="Date">
                                                <DateInput DisplayDateFormat="dd-MM-yyyy" runat="server" /> 
                                            </telerik:RadDatePicker>
                                        </InsertItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Down" HeaderStyle-Width="50px" ItemStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" 
                                            ...
                                            <EditItemTemplate>                                       
                                                <telerik:RadTimePicker ID="rtp_breakdownTimeEdit" DbSelectedDate='<%# DataBinder.Eval(Container, "DataItem.down_time") %>' runat="server" 
                                                    RenderMode="Lightweight" Width="70px" AutoPostBack="false"></telerik:RadTimePicker> 
                                            </EditItemTemplate>
                                            <InsertItemTemplate>                                       
                                                <telerik:RadTimePicker ID="rtp_breakdownTimeInsert" runat="server" 
                                                    RenderMode="Lightweight" Width="70px" AutoPostBack="false"></telerik:RadTimePicker> 
                                            </InsertItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="Act" HeaderStyle-Width="50px" ItemStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" 
                                           ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <EditItemTemplate>
                                                <telerik:RadTimePicker ID="rtp_breakdownActEdit" DbSelectedDate='<%# DataBinder.Eval(Container, "DataItem.down_act") %>' runat="server" 
                                                    RenderMode="Lightweight" Width="70px" AutoPostBack="false"></telerik:RadTimePicker>  
                                            </EditItemTemplate>
                                            <InsertItemTemplate>
                                                <telerik:RadTimePicker ID="rtp_breakdownActInsert" runat="server" 
                                                    RenderMode="Lightweight" Width="70px" AutoPostBack="false"></telerik:RadTimePicker>  
                                            </InsertItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="Up" HeaderStyle-Width="50px" ItemStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" 
                                            ...
                                            <EditItemTemplate>                                        
                                                <telerik:RadTimePicker ID="rtp_breakdownUpEdit" runat="server" DbSelectedDate='<%# DataBinder.Eval(Container, "DataItem.down_up") %>' 
                                                    RenderMode="Lightweight" Width="70px" AutoPostBack="false"></telerik:RadTimePicker>  
                                            </EditItemTemplate>
                                            <InsertItemTemplate>                                        
                                                <telerik:RadTimePicker ID="rtp_breakdownUpInsert" runat="server"  
                                                    RenderMode="Lightweight" Width="70px" AutoPostBack="false"></telerik:RadTimePicker>  
                                            </InsertItemTemplate>
                                        </telerik:GridTemplateColumn>                                
                                        <telerik:GridTemplateColumn HeaderText="Status" HeaderStyle-Width="80px" ItemStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" 
                                          ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <InsertItemTemplate>
                                                <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_bd_statusInsert" EnableLoadOnDemand="True" DataTextField="wo_desc"
                                                    DataValueField="wo_status" AutoPostBack="false"
                                                    HighlightTemplatedItems="true" Width="80px" DropDownWidth="850px" DropDownAutoWidth="Enabled" 
                                                        OnItemsRequested="cb_bd_status_ItemsRequested">                                                   
                                                    <HeaderTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Remark" HeaderStyle-Width="380px" ItemStyle-Width="500px" HeaderStyle-HorizontalAlign="Center" 
                                            ...
                                            <EditItemTemplate>                                        
                                                <telerik:RadTextBox  RenderMode="Lightweight" runat="server" ID="txt_remarkEdit" Width="500px" 
                                                    Text='<%# DataBinder.Eval(Container.DataItem, "remark_activity") %>'>
                                                </telerik:RadTextBox>
                                            </EditItemTemplate>
                                            <InsertItemTemplate>                                        
                                                <telerik:RadTextBox  RenderMode="Lightweight" runat="server" ID="txt_remarkInsert" Width="500px" >
                                                </telerik:RadTextBox>
                                            </InsertItemTemplate>
                                        </telerik:GridTemplateColumn>
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid3" GridLines="None" AutoGenerateColumns="false" PageSize="3"  Skin="Silk"
                                ...
                                <PagerStyle Mode="NumericPages" PageButtonCount="4"></PagerStyle>
                                <HeaderStyle CssClass="gridHeader" ForeColor="Teal" Font-Size="11px" />
                                <MasterTableView CommandItemDisplay="Top" DataKeyNames="sup_code" Font-Size="11px" EditMode="InPlace"
                                    ShowHeadersWhenNoRecords="true" AutoGenerateColumns="False" CommandItemSettings-AddNewRecordText="New" InsertItemDisplay="Bottom">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Date" HeaderStyle-Width="100px" ItemStyle-Width="100px" 
                                            ...
                                            <EditItemTemplate>
                                                <telerik:RadDatePicker runat="server" ID="dtpDateEdit" Width="100px"
                                                    DbSelectedDate='<%#DataBinder.Eval(Container, "DataItem.trans_date")%>' 
                                                    onkeydown="blurTextBox(this, event)" Type="Date">
                                                    <DateInput DisplayDateFormat="dd-MM-yyyy" runat="server" ReadOnly="true" /> 
                                                </telerik:RadDatePicker>
                                            ...
                                            <InsertItemTemplate>
                                                <telerik:RadDatePicker runat="server" ID="dtpDateInsert" Width="100px" 
                                                    onkeydown="blurTextBox(this, event)" Type="Date">
                                                    <DateInput DisplayDateFormat="dd-MM-yyyy" runat="server" ReadOnly="true" /> 
                                                </telerik:RadDatePicker>
                                            </InsertItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Supplier Code" HeaderStyle-Width="120px" ItemStyle-Width="120px" 
                                            ...
                                            <EditItemTemplate>
                                                <asp:Label runat="server" ID="lbl_SupCodeEdit" Text='<%# DataBinder.Eval(Container.DataItem, "sup_code") %>'></asp:Label>
                                            </EditItemTemplate>   
                                            <InsertItemTemplate>
                                                <asp:Label runat="server" ID="lbl_SupCodeInsert" ></asp:Label>
                                            </InsertItemTemplate>                                
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="Supplier" HeaderStyle-Width="320px" ItemStyle-Width="320px" 
                                            ...
                                            <EditItemTemplate>
                                                <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_supplierEdit" EnableLoadOnDemand="True" DataTextField="supplier_name"
                                            ...
                                            <InsertItemTemplate>
                                                <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_supplierInsert" EnableLoadOnDemand="True" DataTextField="supplier_name"
                                                    DataValueField="supplier_code" AutoPostBack="true" 
                                                    HighlightTemplatedItems="true" Width="320px" DropDownWidth="550px" DropDownAutoWidth="Enabled" 
                                                    OnItemsRequested="cb_supplier_ItemsRequested" 
                                                    OnSelectedIndexChanged="cb_supplier_SelectedIndexChanged" >                                                   
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Description" HeaderStyle-Width="350px" ItemStyle-Width="350px" HeaderStyle-HorizontalAlign="Center" 
                                            ...
                                            <EditItemTemplate>
                                                <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_descriptionEdit" Width="350px"
                                                    Text='<%# DataBinder.Eval(Container, "DataItem.description") %>'>
                                                </telerik:RadTextBox>
                                            </EditItemTemplate>                                    
                                            <InsertItemTemplate>
                                                <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_descriptionInsert" Width="350px">
                                                </telerik:RadTextBox>
                                            </InsertItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="Cost" HeaderStyle-Width="110px" ItemStyle-Width="110px" ItemStyle-HorizontalAlign="Right" 
                                            ...
                                            <EditItemTemplate>
                                                <telerik:RadNumericTextBox RenderMode="Lightweight" runat="server" ID="txt_rateEdit" Width="110px"
                                                    EnabledStyle-HorizontalAlign="Right"
                                                    NumberFormat-AllowRounding="true"
                                                    NumberFormat-KeepNotRoundedValue="true" AllowOutOfRangeAutoCorrect="false"
                                                    DbValue='<%# DataBinder.Eval(Container.DataItem, "price", "{0:#,###,###0.00}") %>'                                            
                                            ...
                                            <InsertItemTemplate>
                                                <telerik:RadNumericTextBox RenderMode="Lightweight" runat="server" ID="txt_rateInsert" Width="110px"
                                                    EnabledStyle-HorizontalAlign="Right"
                                                    NumberFormat-AllowRounding="true"
                                                    NumberFormat-KeepNotRoundedValue="true" AllowOutOfRangeAutoCorrect="false"                                           
                                                    onkeydown="blurTextBox(this, event)"
                                        ...
                                        <telerik:GridButtonColumn UniqueName="DeleteColumn" Text="Del" CommandName="Delete" 
                                            ConfirmText="Data yang telah dihapus tidak bisa dikembalikan. Yakin akan menghapus?" ConfirmTitle="Delete" 
                                            ConfirmDialogType="Classic" ButtonType="FontIconButton" ItemStyle-Width="70px" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Center" ItemStyle-ForeColor="Red">
                                        </telerik:GridButtonColumn>
                                    </Columns>
                                </MasterTableView>
                            </telerik:RadGrid>
                ...
                <telerik:RadPageView runat="server" ID="RadPageView4" Height="290px">
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid4" GridLines="None" AutoGenerateColumns="false" PageSize="5"  Skin="Silk"
                                ...
                                <PagerStyle Mode="NumericPages" PageButtonCount="4"></PagerStyle>
                                <HeaderStyle CssClass="gridHeader" ForeColor="Teal" Font-Size="11px" />
                                <MasterTableView CommandItemDisplay="Top" DataKeyNames="OprCode" Font-Size="11px" EditMode="InPlace"
                                    ...
                                    <Columns>              
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Opr. Code" HeaderStyle-Width="120px" ItemStyle-Width="120px" HeaderStyle-HorizontalAlign="Center" 
                                            ...
                                            <EditItemTemplate>
                                                <asp:Label runat="server" ID="lbl_chart_codeEdit" Text='<%# DataBinder.Eval(Container.DataItem, "OprCode") %>'></asp:Label>
                                            </EditItemTemplate>
                                            <InsertItemTemplate>
                                                <asp:Label runat="server" ID="lbl_chart_codeInsert" ></asp:Label>
                                            </InsertItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="Maintenance Operation" HeaderStyle-Width="200px" ItemStyle-Width="200px" HeaderStyle-HorizontalAlign="Left" 
                                            ...
                                            <EditItemTemplate>                                 
                                                <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_operationEdit" EnableLoadOnDemand="True" DataTextField="OprCode"
                                        ...
                                        <InsertItemTemplate>
                                                <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_operationInsert" EnableLoadOnDemand="True" DataTextField="OprCode"
                                                        DataValueField="OprCode" AutoPostBack="true" CausesValidation="false"
                                                        HighlightTemplatedItems="true" Width="180px" DropDownWidth="400px" DropDownAutoWidth="Enabled" 
                                                        OnItemsRequested="cb_operation_ItemsRequested"
                                                        OnSelectedIndexChanged="cb_operation_SelectedIndexChanged">                                                   
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Run" HeaderStyle-Width="30px" ItemStyle-Width="30px" Visible="false">
                                            ...
                                            <InsertItemTemplate>                                        
                                                <telerik:RadTextBox  RenderMode="Lightweight" runat="server" ID="lbl_runEdit" Width="30px"  ReadOnly="true" Text="0" >
                                                </telerik:RadTextBox>
                                            </InsertItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridButtonColumn UniqueName="DeleteColumn" Text="Del" CommandName="Delete" 
                                            ConfirmText="Data yang telah dihapus tidak bisa dikembalikan. Yakin akan menghapus?" ConfirmTitle="Delete" ConfirmDialogType="Classic" 
                                            ButtonType="FontIconButton" ItemStyle-Width="40px" HeaderStyle-Width="40px">
                                        </telerik:GridButtonColumn>
                                    </Columns>
                                </MasterTableView>
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid5" GridLines="None" AutoGenerateColumns="false" PageSize="5" Skin="Silk"
                                ...
                                OnUpdateCommand="RadGrid5_UpdateCommand"                                 
                                ...
                                <MasterTableView CommandItemDisplay="Top" DataKeyNames="part_code,sro_code" Font-Size="11px" EditMode="InPlace"
                                    ...
                                    <CommandItemSettings ShowRefreshButton="False" ShowSaveChangesButton="False" ShowAddNewRecordButton="true"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="MR. Code" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" 
                                                    HeaderStyle-ForeColor="#009900" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lbl_trans_id" Width="100px" Text='<%# DataBinder.Eval(Container.DataItem, "sro_code") %>'></asp:Label>
                                                </ItemTemplate>
                                                 <EditItemTemplate> 
                                                     <asp:Label runat="server" ID="lbl_trans_id_EditTemp" Width="100px" Text='<%# DataBinder.Eval(Container.DataItem, "sro_code") %>'></asp:Label>
                                                </EditItemTemplate>
                                                <InsertItemTemplate>
                                                    <asp:Label runat="server" ID="lbl_trans_id_insertTemp" Width="100px"></asp:Label>
                                                </InsertItemTemplate>
                                            </telerik:GridTemplateColumn>                                            
                                            <telerik:GridTemplateColumn HeaderText="Opr. Code" HeaderStyle-Width="80px" ItemStyle-Width="80px" HeaderStyle-HorizontalAlign="Left" 
                                                    HeaderStyle-ForeColor="#009900">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lbl_operation" Width="80px" Text='<%# DataBinder.Eval(Container.DataItem, "chart_code") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>                                 
                                                    <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_operationEditTemp" EnableLoadOnDemand="True" DataTextField="OprCode"
                                                        DataValueField="OprCode" AutoPostBack="true" CausesValidation="false" Enabled="false"
                                                        HighlightTemplatedItems="true" Width="80px" DropDownWidth="300px" DropDownAutoWidth="Enabled" 
                                                        ...
                                                        <ItemTemplate>
                                                            <table style="width: 300px; font-size:smaller">
                                                                <tr>        
                                                                    <td style="width: 250px;">
                                                                        <%# DataBinder.Eval(Container, "Attributes['OprCode']")%>
                                                                    </td>   
                                                                    <td style="width: 50px;">
                                                                        <%# DataBinder.Eval(Container, "Value")%>
                                                                    </td>                                                                               
                                                ...
                                                <InsertItemTemplate>
                                                    <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_operation_insertTemp" EnableLoadOnDemand="True" DataTextField="OprCode"
                                                        DataValueField="OprCode" AutoPostBack="true" CausesValidation="false"
                                                        HighlightTemplatedItems="true" Width="100px" DropDownWidth="300px" DropDownAutoWidth="Enabled" 
                                                        OnItemsRequested="cb_MR_operation_ItemsRequested"
                                                        OnSelectedIndexChanged="cb_MR_operation_SelectedIndexChanged">                                                   
                                                        <HeaderTemplate>
                                                        <table style="width: 300px; font-size:smaller">
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Operation" Visible="true" HeaderStyle-Width="120px" ItemStyle-Width="120px" HeaderStyle-HorizontalAlign="Center" 
                                                    HeaderStyle-ForeColor="#009900" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lbl_oprCode" Width="120px" Text='<%# DataBinder.Eval(Container.DataItem, "OprName") %>'></asp:Label>
                                                </ItemTemplate>
                                                 <EditItemTemplate> 
                                                     <asp:Label runat="server" ID="lbl_oprCode_EditTemp" Width="120px" Text='<%# DataBinder.Eval(Container.DataItem, "OprName") %>'></asp:Label>
                                                </EditItemTemplate>
                                                <InsertItemTemplate>
                                                    <asp:Label runat="server" ID="lbl_oprCode_insertTemp" Width="120px"></asp:Label>
                                                </InsertItemTemplate>
                                            </telerik:GridTemplateColumn>                                                                                     
                                            <telerik:GridTemplateColumn HeaderText="Type" HeaderStyle-Width="40px" ItemStyle-Width="40px" HeaderStyle-HorizontalAlign="Center" 
                                                    HeaderStyle-ForeColor="#009900" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lbl_prodType" Width="40px" Text='<%# DataBinder.Eval(Container.DataItem, "prod_type") %>'></asp:Label>
                                                </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:Label runat="server" ID="lbl_prodType_editTemp" Width="40px" Text='<%# DataBinder.Eval(Container.DataItem, "prod_type") %>'></asp:Label>
                                            </EditItemTemplate>
                                                <InsertItemTemplate>
                                                    <asp:Label runat="server" ID="lbl_prodType_insertTemp" Width="40px" ></asp:Label>
                                                </InsertItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            <telerik:GridTemplateColumn HeaderText="Material Code" HeaderStyle-Width="130px" ItemStyle-Width="130px" HeaderStyle-HorizontalAlign="Center" 
                                                ...
                                                <EditItemTemplate>
                                                    <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_prod_codeEditTemp" EnableLoadOnDemand="True" DataTextField="Prod_code"
                                                        DataValueField="Prod_code" AutoPostBack="true" Enabled="false" CausesValidation="false"
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Qty" HeaderStyle-Width="70px" ItemStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" 
                                                ...
                                                <EditItemTemplate>
                                                    <telerik:RadNumericTextBox RenderMode="Lightweight" runat="server" ID="txtPartQtyEditTemp" Width="70px"  ReadOnly="false" 
                                                        EnabledStyle-HorizontalAlign="Right"
                                                        NumberFormat-AllowRounding="true"
                                                        NumberFormat-KeepNotRoundedValue="true" AllowOutOfRangeAutoCorrect="false"
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Remark" HeaderStyle-Width="270px" ItemStyle-Width="270px" HeaderStyle-HorizontalAlign="Center" 
                                                    HeaderStyle-ForeColor="#009900">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lbl_remark" Width="270px" Text='<%# DataBinder.Eval(Container.DataItem, "remark") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_remark_editTemp" Width="270px"
                                                        Text='<%# DataBinder.Eval(Container, "DataItem.remark") %>'>
                                                    </telerik:RadTextBox>
                                                </EditItemTemplate>
                                                <InsertItemTemplate>
                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_remark_insertTemp" Width="270px"
                                                    ></telerik:RadTextBox>
                                                </InsertItemTemplate>
                                            </telerik:GridTemplateColumn>                                
