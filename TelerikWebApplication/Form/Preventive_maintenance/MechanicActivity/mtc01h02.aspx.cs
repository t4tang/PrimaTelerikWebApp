...
{
    public partial class mtc01h02 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                lbl_form_name.Text = "Mechanic Activity";
        ...
        public DataTable GetDataTable(string fromDate, string toDate, string project)
        {
            ...
            cmd.Connection = con;
            cmd.CommandText = "sp_get_mechanic_activityH";
        ...
        protected void RadGrid1_ItemCreated(object sender, GridItemEventArgs e)
        {
            if (e.Item is GridDataItem)
            {
                ...
                editLink.Attributes["onclick"] = String.Format("return ShowEditForm('{0}','{1}');", e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["jobno"], e.Item.ItemIndex);

                ImageButton printLink = (ImageButton)e.Item.FindControl("PrintLink");
                printLink.Attributes["href"] = "javascript:void(0);";
                printLink.Attributes["onclick"] = String.Format("return ShowPreview('{0}','{1}');", e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["jobno"], e.Item.ItemIndex);
        ...
        protected void cb_job_code_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            ...
            try
            {
                ...
                foreach (DataRow dtr in dt.Rows)
                {
                    ...
                    RadTextBox T_Hour = (RadTextBox)item.FindControl("txt_time_tot");
                    RadTextBox T_Act = (RadTextBox)item.FindControl("txtactivity");
