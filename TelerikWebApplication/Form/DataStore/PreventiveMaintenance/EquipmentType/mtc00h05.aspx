<%@ Page Title="PRIMA SYSTEM" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="mtc00h05.aspx.cs"  Inherits="TelerikWebApplication.Form.DataStore.PreventiveMaintenance.EquipmentType.mtc00h05" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <tr>       
                ...
                <td style="width: 98%; text-align: right; padding-right:17px">
                     <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <telerik:RadLabel ID="lbl_form_name" Text="Equpment Type" runat="server" Style="font-weight: lighter; font-size: 10px; font-variant: small-caps; padding-left: 10px; 
    ...
    <div class="scroller" style="overflow-y:scroll; height:620px"> 
        <telerik:RadGrid ID="RadGrid1" runat="server" RenderMode="Lightweight" ShowFooter="False" 
            ...
            MasterTableView-DataKeyNames="equipment_code" MasterTableView-ClientDataKeyNames="equipment_code" 
            ...
            <MasterTableView CommandItemDisplay="None" Font-Size="11px" Font-Names="Century Gothic">
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText="Code" DataField="equipment_code">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                 <telerik:RadTextBox ID="txt_code_area" runat="server" RenderMode="Lightweight" Width="80" Enabled="true"
                                                    Text='<%# DataBinder.Eval(Container, "DataItem.equipment_code") %>' AutoPostBack="false" >
                                                 </telerik:RadTextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                 <telerik:RadTextBox ID="txt_desc" runat="server" RenderMode="Lightweight" Width="180px" Enabled="true"
                                                    Text='<%# DataBinder.Eval(Container, "DataItem.description") %>' AutoPostBack="false" >
                                                 </telerik:RadTextBox>    
                                            </td>
                                        </tr>
                                    </table>
