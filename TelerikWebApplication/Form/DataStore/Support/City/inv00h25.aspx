<%@ Page Title="PRIMA SYSTEM" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="inv00h25.aspx.cs" Inherits="TelerikWebApplication.Form.DataStore.Support.City.inv00h25" %>
            ...
            <tr>       
                ...
                <td style="width: 98%; text-align: right; padding-right:17px">
                     <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <telerik:RadLabel ID="lbl_form_name" Text="Master City" runat="server" Style="font-weight: lighter; font-size: 10px; font-variant: small-caps; padding-left: 10px; 
    ...
    <div class="scroller" style="overflow-y:scroll; height:620px"> 
        <telerik:RadGrid ID="RadGrid1" runat="server" RenderMode="Lightweight" AllowPaging="True" 
            ...
            OnDeleteCommand ="RadGrid1_DeleteCommand" Skin ="Silk" OnItemCreated ="RadGrid1_ItemCreated"
             MasterTableView-CommandItemDisplay="Top" MasterTableView-DataKeyNames="city_code" MasterTableView-ClientDataKeyNames="city_code" 
            ...
            <MasterTableView CommandItemDisplay="None" Font-Size="11px" Font-Names="Century Gothic">
                <Columns>
                    <telerik:GridEditCommandColumn UniqueName ="EditCommandColumn">
                     ...
                     <telerik:GridBoundColumn HeaderText ="Code" DataField ="city_code" >
                    ...
                    <FormTemplate>
                          <table id="Table2" cellspacing="4" cellpadding="5" width="100%" border="0" rules="none" class="formTemplate_Table">
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_city_code" runat="server" Width="150px" Enabled="true"
                                        RenderMode="Lightweight" Text='<%# DataBinder.Eval(Container, "DataItem.city_code") %>' AutoPostBack="false"></telerik:RadTextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_city_name" runat="server" Width="350px" Enabled="true"
