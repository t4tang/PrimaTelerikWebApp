<%@ Page Title="PRIMA SYSTEM" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="mtc00h10.aspx.cs" Inherits="TelerikWebApplication.Form.DataStore.Vehicle.MechanicJobs.mtc00h10" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <tr>       
                ...
                <td style="width: 98%; text-align: right; padding-right:17px">
                     <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <telerik:RadLabel ID="lbl_form_name" Text="Mechanic Jobs" runat="server" Style="font-weight: lighter; font-size: 10px; font-variant: small-caps; padding-left: 10px; 
    ...
    <div class="scroller" style="overflow-y:scroll; height:620px"> 
        <telerik:RadGrid ID="RadGrid1" runat="server" RenderMode="Lightweight" AllowPaging="true" ShowFooter="False" AllowSorting="true"
                         AutoGenerateColumns="false" Skin="Silk" CssClass="RadGrid_ModernBrowsers" OnNeedDataSource="RadGrid1_NeedDataSource"
            ...
            <MasterTableView CommandItemDisplay="None" Font-Size="11px" Font-Names="Century Gothic" DataKeyNames="job_code" Width="100%"
                EditFormSettings-PopUpSettings-KeepInScreenBounds="true">
                <Columns>
                    <telerik:GridEditCommandColumn UniqueName="EditCommandColumn">
                        <HeaderStyle Width="20px" />
                    </telerik:GridEditCommandColumn>
                    <telerik:GridBoundColumn HeaderText ="Code" DataField="job_code">
                        <HeaderStyle Width="200px" />
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText ="Job Name" DataField="job_name">
                        <HeaderStyle Width="200px" />
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText ="Job Type" DataField="status">
                        <HeaderStyle Width="200px" />
                    </telerik:GridBoundColumn>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_code" runat="server" Width="90px" Enabled="true" RenderMode="Lightweight"
                                                        Text='<%#DataBinder.Eval(Container, "DataItem.job_code") %>' AutoPostBack="false">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_name" runat="server" Width="270px" Enabled="true" RenderMode="Lightweight"
                                                        Text='<%#DataBinder.Eval(Container, "DataItem.job_name") %>' AutoPostBack="false">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <telerik:RadComboBox ID="cb_type" runat="server" Width="150px" Enabled="true" RenderMode="Lightweight"
                                                     Text='<%#DataBinder.Eval(Container, "DataItem.status") %>' AutoPostBack="false"
                                                     ShowDropDownOnTextboxClick="true" OnPreRender="cb_type_PreRender" EnableLoadOnDemand="true"
