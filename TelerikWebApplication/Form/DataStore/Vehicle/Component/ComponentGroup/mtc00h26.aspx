<%@ Page Title="PRIMA SYSTEM" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="mtc00h26.aspx.cs" Inherits="TelerikWebApplication.Form.DataStore.Vehicle.Component.ComponentGroup.mtc00h26" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <tr>       
                ...
                <td style="width: 98%; text-align: right; padding-right:17px">
                     <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <telerik:RadLabel ID="lbl_form_name" Text="Component Group" runat="server" Style="font-weight: lighter; font-size: 10px; font-variant: small-caps; padding-left: 10px; 
    ...
    <div class="scroller" style="overflow-y:scroll; height:620px">
        <telerik:RadGrid ID="RadGrid1" runat="server" RenderMode="Lightweight" AllowPaging="true" ShowFooter="False" AllowSorting="true"
                         AutoGenerateColumns="false" Skin="MetroTouch" OnNeedDataSource="RadGrid1_NeedDataSource" CssClass="RadGrid_ModernBrowsers"
            ...
            <MasterTableView CommandItemDisplay="None" Font-Size="11px" Font-Names="Century Gothic" DataKeyNames="com_group" Width="100%"
                EditFormSettings-PopUpSettings-KeepInScreenBounds="true">
                <Columns>
                    <telerik:GridEditCommandColumn UniqueName="EditCommandColumn">
                        <HeaderStyle Width="20px" />
                    </telerik:GridEditCommandColumn>
                    <telerik:GridBoundColumn HeaderText ="Code" DataField="com_group">
                        <HeaderStyle Width="200px" />
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText ="Component Group" DataField="com_group_name">
                        <HeaderStyle Width="200px" />
                    </telerik:GridBoundColumn>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_code" runat="server" Width="90px" Enabled="true" RenderMode="Lightweight"
                                                        Text='<%#DataBinder.Eval(Container, "DataItem.com_group") %>' AutoPostBack="false">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_name" runat="server" Width="270px" Enabled="true" RenderMode="Lightweight"
                                                        Text='<%#DataBinder.Eval(Container, "DataItem.com_group_name") %>' AutoPostBack="false">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr>
