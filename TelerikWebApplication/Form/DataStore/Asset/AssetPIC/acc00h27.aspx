<%@ Page Title="PRIMA SYSTEM" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="acc00h27.aspx.cs" Inherits="TelerikWebApplication.Form.DataStore.Asset.AssetPIC.acc00h24" %>
            ...
            <tr>       
                ...
                <td style="width: 98%; text-align: right; padding-right:17px">
                     <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <telerik:RadLabel ID="lbl_form_name" Text="Asset PIC" runat="server" Style="font-weight: lighter; font-size: 10px; font-variant: small-caps; padding-left: 10px; 
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" RenderMode="Lightweight" AllowPaging="true" ShowFooter="false" AllowSorting="true" CssClass="RadGrid_ModernBrowsers"
            ...
            <MasterTableView CommandItemDisplay="None" AllowFilteringByColumn="true" DataKeyNames="Pic_Code" Font-Size="11px" Font-Names="Century Gothic"
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn HeaderText ="Code" DataField="Pic_Code">
                        <HeaderStyle Width="70px" />
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText ="PIC Name" DataField="pic_name">
                ...
                <EditFormSettings EditFormType="Template">
                        ...
                        <table id="table2" cellspacing="4" cellpadding="5" width="100%" border="0" style="border-collapse: collapse; padding-left:35px; 
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_code" runat="server" Width="70px" Enabled="true" RenderMode="Lightweight" Text='<%#DataBinder.Eval(Container, "DataItem.Pic_Code") %>' AutoPostBack="false">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_pic_name" runat="server" Width="200px" Enabled="true" RenderMode="Lightweight" Text='<%#DataBinder.Eval(Container, "DataItem.pic_name") %>' AutoPostBack="false">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr>
