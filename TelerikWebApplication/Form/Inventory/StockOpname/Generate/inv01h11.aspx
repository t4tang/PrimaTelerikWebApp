<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="inv01h11.aspx.cs" Inherits="TelerikWebApplication.Form.Inventory.StockOpname.Generate.inv01h11" %>
            ...
            <telerik:RadGrid  RenderMode="Lightweight" ID="RadGrid1"  runat="server" AllowPaging="true" ShowFooter="false" Skin="Silk" CssClass="RadGrid_ModernBrowsers" 
                ...
                <Columns>
                    ...
                    <telerik:GridDateTimeColumn UniqueName="rv_date" HeaderText="Date" DataField="rv_date" ItemStyle-Width="80px"
                        ...
                        <telerik:GridBoundColumn UniqueName="wh_name" HeaderText="Warehouse" DataField="wh_name" ItemStyle-Width="160px" FilterControlWidth="160px" 
                                    ...
                                    <MasterTableView CommandItemDisplay="Top" DataKeyNames="Prod_code" Font-Size="11px" EditMode="InPlace"
                                        ...
                                        <Columns>   
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Qty Sys." HeaderStyle-Width="80px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Right" 
                                                ...
                                                <EditItemTemplate>
                                                    <telerik:RadNumericTextBox RenderMode="Lightweight" runat="server" ID="txtPartQtyEdit" Width="80px"  ReadOnly="true" 
                                                        EnabledStyle-HorizontalAlign="Right"
                                                        NumberFormat-AllowRounding="true"
                                                        NumberFormat-KeepNotRoundedValue="true" AllowOutOfRangeAutoCorrect="false"
                                                        Text='<%# DataBinder.Eval(Container.DataItem, "qty_sis", "{0:#,###,###0.00}") %>'
                                                ...
                                                <InsertItemTemplate>
                                                    <telerik:RadNumericTextBox RenderMode="Lightweight" runat="server" ID="txtPartQtyInsert" Width="80px"  ReadOnly="true" 
                                                        EnabledStyle-HorizontalAlign="Right"
                                                        NumberFormat-AllowRounding="true"
                                                        NumberFormat-KeepNotRoundedValue="true" AllowOutOfRangeAutoCorrect="false"
                                                        onkeydown="blurTextBox(this, event)"
