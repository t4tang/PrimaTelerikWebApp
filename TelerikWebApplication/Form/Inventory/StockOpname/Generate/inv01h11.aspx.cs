    ...
    public partial class inv01h11 : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    con.Open();
                    SqlDataReader sdr;
                    cmd = new SqlCommand("SELECT ISNULL ( MAX ( RIGHT ( inv01h11.rv_code , 4 ) ) , 0 ) + 1 AS maxNo " +
                       "FROM inv01h11 WHERE LEFT(inv01h11.rv_code, 4) ='SR01' " +
                       "AND SUBSTRING(inv01h11.rv_code, 5, 2) = SUBSTRING('" + trDate + "', 9, 2) " +
                       "AND SUBSTRING(inv01h11.rv_code, 7, 2) = SUBSTRING('" + trDate + "', 4, 2) ", con);
        ...
        protected void RadGrid2_DeleteCommand(object sender, GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = con;
                cmd.CommandText = "delete from inv01d11 where prod_code = @prod_code and rv_code = @rv_code";
