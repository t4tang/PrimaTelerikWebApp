...
namespace TelerikWebApplication.Form.Inventory.GoodsIssued
{
    public partial class inv01h05 : System.Web.UI.Page
    {
        ...
        protected void cb_loc_PreRender(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "SELECT wh_code FROM inv00h05 WHERE wh_name = '" + cb_loc.Text + "'";
            SqlDataReader dr;
            dr = cmd.ExecuteReader();
            while (dr.Read())
                cb_loc.SelectedValue = dr["wh_code"].ToString();
            dr.Close();
            con.Close();
        }
        ...
        protected void btnSave_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@wh_code", cb_loc.SelectedValue);
                ...
                foreach (GridDataItem item in RadGrid2.MasterTableView.Items)
                {
                    ...
                    cmd.Parameters.AddWithValue("@tWarranty", (item.FindControl("lblWarranty") as Label).Text);
