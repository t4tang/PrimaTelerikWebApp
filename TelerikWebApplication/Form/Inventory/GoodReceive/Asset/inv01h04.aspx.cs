...
namespace TelerikWebApplication.Form.Inventory.GoodReceive.Asset
{
    public partial class inv01h04 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                lbl_form_name.Text = "Goods Receipt Asset";
        ...
        protected void cb_ref_ItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
        {
            ...
            (sender as RadComboBox).Text = "";
            LoadReff(e.Text, selected_project, cb_supplier.SelectedValue, (sender as RadComboBox));
        ...
        public DataTable GetDataRefDetailTable(string doc_code, string wh_code)
        {
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Connection = con;
            cmd.CommandText = "sp_get_goods_receive_asset_refD";
