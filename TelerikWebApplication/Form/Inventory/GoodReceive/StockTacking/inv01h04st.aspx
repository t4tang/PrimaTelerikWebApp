<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="inv01h04st.aspx.cs" Inherits="TelerikWebApplication.Form.Inventory.GoodReceive.StockTacking.inv01h04st" %>
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" runat="server" AllowPaging="True" ShowFooter="false" PageSize="14" Skin="Silk"
            ...
            <MasterTableView Width="100%" CommandItemDisplay="Top" DataKeyNames="lbm_code" Font-Size="11px" Font-Names="Century Gothic"
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn UniqueName="reg_no" HeaderText="Reg. Number" DataField="lbm_code">
                        <HeaderStyle Width="120px"></HeaderStyle>
                    </telerik:GridBoundColumn>
                    <telerik:GridDateTimeColumn UniqueName="reg_date" HeaderText="Date" DataField="lbm_date" ItemStyle-Width="110px" 
                    ...
                    <telerik:GridBoundColumn UniqueName="remark" HeaderText="Remark" DataField="remark" ItemStyle-Wrap="true"
                            ItemStyle-Width="750px" AllowFiltering="false">
                        <HeaderStyle Width="750px"></HeaderStyle>
                    </telerik:GridBoundColumn>
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <div style="padding: 15px 0px 0px 25px;">
                                ...
                                <tr style="vertical-align: top;">
                                    <td style="vertical-align: top;">
                                        <table id="Table2" width="Auto" border="0" class="module">
                                            ...
                                            <tr>
                                                <td class="tdLabel">                                                    
                                                    <telerik:RadLabel runat="server" Text="Reg. Number" CssClass="lbObject" ForeColor="Black"></telerik:RadLabel>
                                                </td>
                                                <td>
                                                    <telerik:RadTextBox ID="txt_reg_number" runat="server" Width="150px" ReadOnly="true" RenderMode="Lightweight"
                                                      Text='<%# DataBinder.Eval(Container, "DataItem.lbm_code") %>'  AutoPostBack="false">
                                                    </telerik:RadTextBox>
                                                </td>
                                            </tr>             
                                            <tr>
                                                ...
                                                <td>               
                                                    <telerik:RadDatePicker ID="dtp_date" runat="server" RenderMode="Lightweight" MinDate="1/1/1900" Width="150px" 
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align:top; text-align:left">                      
                                                    <telerik:RadComboBox RenderMode="Lightweight" ID="cb_project" runat="server" Width="200" DropDownWidth="200px"
                                                        Text='<%# DataBinder.Eval(Container, "DataItem.region_name") %>' CausesValidation="false"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <telerik:RadComboBox RenderMode="Lightweight" ID="cb_supplier" runat="server" Width="250"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <telerik:RadTextBox ID="txt_ref_no" Text='<%# DataBinder.Eval(Container, "DataItem.ref_code") %>'
                                                        runat="server" Width="150px" Rows="0" TabIndex="5" >
                                                    </telerik:RadTextBox> 
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td style="vertical-align: top; padding-left:15px">
                                        <table id="Table3" border="0" class="module">
                                            <%--<tr>
                                                ...
                                                <td>
                                                    <telerik:RadTextBox ID="txt_delivery_note" Text='<%# DataBinder.Eval(Container, "DataItem.ref_code") %>'
                                                        runat="server" Width="250px" Rows="0" TabIndex="5" >
                                                    </telerik:RadTextBox> 
                                                </td>
                                            </tr>--%>
                                            <tr >
                                            ...
                                            <tr >
                                                ...
                                                <td style="vertical-align:top; text-align:left">                                   
                                                    <telerik:RadComboBox RenderMode="Lightweight" ID="cb_warehouse" runat="server" Width="250px" DropDownWidth="300px"
                                            ...
                                            <td style="vertical-align:top; text-align:left">
                                                <telerik:RadComboBox RenderMode="Lightweight" ID="cb_createdBy" runat="server" Width="250px" 
                                                Text='<%# DataBinder.Eval(Container, "DataItem.CreateName") %>'
                                            ...
                                            <td style="vertical-align:top; text-align:left">
                                                <telerik:RadComboBox RenderMode="Lightweight" ID="cb_requestBy" runat="server" Width="250px" 
                                                Text='<%# DataBinder.Eval(Container, "DataItem.ReceiveName") %>'
                                                    DropDownWidth="450px" EnableLoadOnDemand="True" HighlightTemplatedItems="true" 
                                                    MarkFirstMatch="true" Skin="Silk"  EnableVirtualScrolling="true"                                                    
                                                    OnItemsRequested="cb_approval_ItemsRequested" 
                                                    OnSelectedIndexChanged="cb_approval_SelectedIndexChanged"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align:top; text-align:left">
                                                    ...
                                                    Text='<%# DataBinder.Eval(Container, "DataItem.ApproveName") %>'
                                                    DropDownWidth="450px" EnableLoadOnDemand="True" HighlightTemplatedItems="true" 
                                                    MarkFirstMatch="true" Skin="Silk"  EnableVirtualScrolling="true" 
                                                    OnItemsRequested="cb_approval_ItemsRequested" 
                                                    OnSelectedIndexChanged="cb_approval_SelectedIndexChanged"
                            ...
                            <div style="padding: 7px 0px 12px 0px; height:295px">                               
                                <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid2" runat="server" AllowPaging="False" ShowFooter="false" PageSize="5" Skin="Silk"
                                    ...
                                    <MasterTableView CommandItemDisplay="Top" DataKeyNames="lbm_code,prod_code" Font-Size="11px" EditMode="InPlace"
                                        ...
                                        <Columns>   
                                            ...
                                            <telerik:GridTemplateColumn UniqueName="prod_code" HeaderText="Product Code" HeaderStyle-Width="120px"
                                                ...
                                                <EditItemTemplate>
                                                    <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_prod_code_edit" EnableLoadOnDemand="True" DataTextField="spec"
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Part Name"  HeaderStyle-Width="200px" ItemStyle-Width="200px">
                                                ...
                                                <EditItemTemplate>
                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_prod_name_edit" Width="200px" ReadOnly="true"
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="St Main"  HeaderStyle-Width="80px" ItemStyle-Width="80px">
                                                <ItemTemplate> 
                                                    <asp:Label ID="lbl_stMain" Width="80px" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.stMain") %>' ></asp:Label> 
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_stMain_edit" Width="80px" ReadOnly="true"
                                                        Text='<%# DataBinder.Eval(Container, "DataItem.stMain") %>'>
                                                    </telerik:RadTextBox>
                                                </EditItemTemplate>
                                                <InsertItemTemplate>
                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_stMain_insert" Width="80px" ReadOnly="true">
                                                    </telerik:RadTextBox>
                                                </InsertItemTemplate>
                                            </telerik:GridTemplateColumn> 
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Qty" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Right" 
                                                ...
                                                <ItemTemplate> 
                                                    <asp:Label ID="lbl_qty" Width="100px" runat="server" CssClass="detailItem" Text='<%# DataBinder.Eval(Container, "DataItem.qty_receive", "{0:#,###,###0.00}") %>' ></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <telerik:RadNumericTextBox  RenderMode="Lightweight" runat="server" ID="txt_qty_edit" Width="90px" NumberFormat-AllowRounding="true"
                                                ...
                                                <InsertItemTemplate>
                                                    <telerik:RadNumericTextBox  RenderMode="Lightweight" runat="server" ID="txt_qty_insert" Width="90px" NumberFormat-AllowRounding="true"
                                                        NumberFormat-KeepNotRoundedValue="true" AllowOutOfRangeAutoCorrect="false" EnabledStyle-HorizontalAlign="Right"
                                                        onkeydown="blurTextBox(this, event)"
                                                        AutoPostBack="true" MaxLength="11" Type="Number"
                                                        NumberFormat-DecimalDigits="2" >
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="UoM"  HeaderStyle-Width="70px" ItemStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" >
                                                <ItemTemplate>   
                                                    <asp:Label ID="lbl_uom" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.SatQty") %>' ></asp:Label> 
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <telerik:RadComboBox RenderMode="Lightweight" DropDownWidth="70px" runat="server" ID="cb_uom_edit"
                                                ...
                                                <InsertItemTemplate>
                                                    <telerik:RadComboBox RenderMode="Lightweight" DropDownWidth="70px" runat="server" ID="cb_uom_insert"
                                                        EnableLoadOnDemand="True" Skin="Silk"  DataTextField="part_unit" DataValueField="part_unit" >
                                                    </telerik:RadComboBox>
                                                </InsertItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_kolok" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.KoLok") %>' ></asp:Label>
                                            </ItemTemplate>                                            
                                            <EditItemTemplate>                                                
                                                <telerik:RadComboBox runat="server" RenderMode="Lightweight" ID="cb_kolok_edit" Width="100px" Skin="Silk"
                                            ...
                                            <InsertItemTemplate>
                                                <telerik:RadComboBox runat="server" RenderMode="Lightweight" ID="cb_kolok_insert" Width="100px" Skin="Silk"
                                                    EnableLoadOnDemand="True" EnableVirtualScrolling="true" Filter="Contains" MarkFirstMatch="true" ChangeTextOnKeyBoardNavigation="false"  
                                                    DataTextField="kolok" DataValueField="kolok" OnItemsRequested="cbKolok_ItemsRequested">
                                                </telerik:RadComboBox>
                                            </InsertItemTemplate>                               
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Cost Center"  HeaderStyle-Width="100px" ItemStyle-Width="100px">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_dept" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.dept_code") %>' ></asp:Label> 
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <telerik:RadComboBox RenderMode="Lightweight" DropDownWidth="100px" runat="server" ID="cb_dept_edit"
                                                ...
                                                <InsertItemTemplate>
                                                    <telerik:RadComboBox RenderMode="Lightweight" DropDownWidth="100px" runat="server" ID="cb_dept_insert"
                                                        EnableLoadOnDemand="True" Skin="Silk"  DataTextField="name" DataValueField="CostCenter"
                                                        OnItemsRequested="cb_cost_center_ItemsRequested" 
                                                        OnPreRender="cb_cost_center_PreRender"
                                                        OnSelectedIndexChanged="cb_cost_center_SelectedIndexChanged" >
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="MAP/ Unit" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Right" 
                                                HeaderStyle-HorizontalAlign="Center" DefaultInsertValue="0">
                                                <ItemTemplate> 
                                                    <asp:Label ID="lbl_hpokok" Width="120px" runat="server" CssClass="detailItem" Text='<%# DataBinder.Eval(Container, "DataItem.hpokok_idr", "{0:#,###,###0.00}") %>' ></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <telerik:RadNumericTextBox  RenderMode="Lightweight" runat="server" ID="txt_hpokok_edit" Width="100px" NumberFormat-AllowRounding="true"
                                                        NumberFormat-KeepNotRoundedValue="true" AllowOutOfRangeAutoCorrect="false" EnabledStyle-HorizontalAlign="Right"
                                                        Text='<%# DataBinder.Eval(Container.DataItem, "hpokok_idr", "{0:#,###,###0.00}") %>'
                                                        onkeydown="blurTextBox(this, event)"
                                                        AutoPostBack="true" MaxLength="11" Type="Number"
                                                        NumberFormat-DecimalDigits="2" >
                                                    </telerik:RadNumericTextBox>
                                                ...
                                                <InsertItemTemplate>
                                                    <telerik:RadNumericTextBox  RenderMode="Lightweight" runat="server" ID="txt_hpokok_insert" Width="100px" NumberFormat-AllowRounding="true"
                                                        NumberFormat-KeepNotRoundedValue="true" AllowOutOfRangeAutoCorrect="false" EnabledStyle-HorizontalAlign="Right"
                                                        onkeydown="blurTextBox(this, event)"
                                                        AutoPostBack="true" MaxLength="11" Type="Number"
                                                        NumberFormat-DecimalDigits="2" >
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Remark"  HeaderStyle-Width="200px" ItemStyle-Width="200px">
                                                <ItemTemplate> 
                                                    <asp:Label ID="lbl_remark" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.remark") %>' ></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_remark_edit" Width="200px"
                                                        Text='<%# DataBinder.Eval(Container, "DataItem.remark") %>'>
                                                    </telerik:RadTextBox>
                                                </EditItemTemplate>
                                                <InsertItemTemplate>
                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_remark_insert" Width="200px">
                                                    </telerik:RadTextBox>
                                                </InsertItemTemplate>
                                            </telerik:GridTemplateColumn> 
