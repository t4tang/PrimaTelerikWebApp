...
{
    public partial class inv01h04r : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        //throw new Exception();
                        run = "GR01" + dtp_return.SelectedDate.Value.Year + dtp_return.SelectedDate.Value.Month + "0001";
                    }
                    else if (sdr.Read())
                    {
                ...
                cmd.Parameters.AddWithValue("@lbm_date", string.Format("{0:yyyy-MM-dd}", dtp_return.SelectedDate.Value));
                ...
                inv01h04r.tr_code = run;
                inv01h04r.selected_project = cb_project.SelectedValue;
