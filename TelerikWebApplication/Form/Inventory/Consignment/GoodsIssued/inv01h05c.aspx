<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="inv01h05c.aspx.cs" Inherits="TelerikWebApplication.Form.Inventory.Consignment.GoodsIssued.inv01h05c" %>
                                                ...
                                                <%--<tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadComboBox ID="cb_CustSupp" runat="server" RenderMode="Lightweight" Skin="Telerik" EnableLoadOnDemand="true"  HighlightTemplatedItems="true"
                                                            ...
                                                            AutoPostBack="true"  Text='<%# DataBinder.Eval(Container, "DataItem.supplier_name") %>'
                                                        ...
                                                        <telerik:RadComboBox ID="cb_ref" runat="server" RenderMode="Lightweight" Width="200px" DataTextField="ref_code" DataValueField="ref_code" 
                                                            ...
                                                            <ItemTemplate>
                                                                <table style="width: 650px; font-size:smaller">
                                                                    <tr>
                                                                        <td style="width: 150px;">
                                                                            <%# DataBinder.Eval(Container, "DataItem.reff_code")%>
                                                                        </td>
                                                                        <td style="width: 150px;">
                                                                            <%# DataBinder.Eval(Container, "DataItem.rs_code")%>
                                                                        </td>
                                                                        <td style="width: 250px;">
                                            ...
                                            <div runat="server" style="padding:10px 10px 10px 10px">
                                                ...
                                                AllowSorting="True" AutoGenerateColumns="False" ShowStatusBar="true" CssClass="RadGrid_ModernBrowsers"
                                                    ...
                                                    <CommandItemSettings ShowRefreshButton="False" ShowSaveChangesButton="False" /> 
                                                                ...
                                                                <ItemTemplate>
                                                                    <table style="width: 430px; font-size:smaller">
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 250px;">
                                                                                <%# DataBinder.Eval(Container, "Attributes['SatQty']")%>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </ItemTemplate>
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Info Record" HeaderStyle-Width="110px" ItemStyle-Width="110px" HeaderStyle-HorizontalAlign="Center" 
                                                                >
                                                                <ItemTemplate>
                                                                    <asp:Label runat="server" ID="lbl_info_code" Width="110px" Text='<%# DataBinder.Eval(Container.DataItem, "info_code") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Qty" HeaderStyle-Width="90px" ItemStyle-Width="90px" ItemStyle-HorizontalAlign="Right" 
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label runat="server" ID="lbl_Part_Qty" Width="90px" Text='<%# DataBinder.Eval(Container.DataItem, "qty_out", "{0:#,###,###0.00}") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                                    <telerik:RadNumericTextBox RenderMode="Lightweight" runat="server" ID="txtPartQty" Width="90px" EnabledStyle-HorizontalAlign="Right"
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Uom" HeaderStyle-Width="80px" ItemStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" 
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label runat="server" ID="lblUom" Width="80px" Text='<%# DataBinder.Eval(Container.DataItem, "unit_code") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                                    <telerik:RadComboBox RenderMode="Lightweight" DropDownWidth="100px" runat="server" ID="cb_uom_d"
                                                                        Text='<%# DataBinder.Eval(Container, "DataItem.unit_code") %>' Width="100px"
                                                            ...
                                                            <%--<telerik:GridTemplateColumn HeaderText="Cost Center" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" 
                                                                ItemStyle-HorizontalAlign="Center" >
                                                                <ItemTemplate>
                                                                    <asp:Label runat="server" ID="lblCostCntr" Width="100px" Text='<%# DataBinder.Eval(Container.DataItem, "dept_code") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </telerik:GridTemplateColumn>  --%>                                  
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Remark" HeaderStyle-Width="300px" ItemStyle-Width="300px" HeaderStyle-HorizontalAlign="Center" >
                                                                <ItemTemplate>
                                                                    <asp:Label runat="server" ID="lblremark" Width="300px" Text='<%# DataBinder.Eval(Container.DataItem, "remark") %>'></asp:Label>                                 
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                                    <telerik:RadTextBox runat="server" ID="txtRemark" Width="300px" Text='<%# DataBinder.Eval(Container.DataItem, "remark") %>'></telerik:RadTextBox>
                                                                </EditItemTemplate>
                                                                <InsertItemTemplate>
                                                    ...
                                                    <ClientSettings>
                                                        <Scrolling AllowScroll="true" UseStaticHeaders="true" ScrollHeight="209" />
