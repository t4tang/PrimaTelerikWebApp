<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="acc00h11.aspx.cs" Inherits="TelerikWebApplication.Form.Security.Closing.Monthly.acc00h11" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="scroller" runat="server">
        <div runat="server" style="width: 100%; border-top-color:yellowgreen; border-top-width: 1px; border-top-style: inset; padding-top: 8px;height:100%; overflow-y:auto; overflow-x:hidden">   
            <div runat="server"  style="display:inline-block; width:35%">
                ...
                <div runat="server" title="Process Type" style="padding:25px 0px 25px 0px">
                    ...
                    <asp:RadioButtonList ID="rblPost" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Selected="True" Value="1">Close</asp:ListItem>
                ...
                <div class="submitButton">
                    ...
                    <telerik:RadButton RenderMode="Lightweight" ID="btnProcessing" runat="server" Text="Start Closing Process" CssClass="btn-wrapper" ForeColor="White"
            ...
            <div runat="server" style="display:inline-block; width:50%">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/month-end.jpg" ImageAlign="Middle" Width="600px" Height="400px" />
            </div>
        </div>
    </div>
</asp:Content>
