<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="acc01h07postNonFld.aspx.cs" Inherits="TelerikWebApplication.Form.Security.Posting.Inventory.NonFluid.acc01h07postNonFld" %>
        ...
        <table id="tbl_control">
            <tr> 
                <td style="text-align: right; width:1300px">
                    <telerik:RadLabel ID="lbl_form_name" runat="server" CssClass="transactionLabel">
                    </telerik:RadLabel>
                </td>
            </tr>
        </table>
