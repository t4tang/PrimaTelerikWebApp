<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TelerikWebApplication.Forms.Reports.Default" %>
    ...
    <div class="scroller" runat="server">
        <telerik:ReportViewer ID="ReportViewer1" runat="server"
            ...
            <ReportSource
                ...
                Identifier="ReportLibrary.ReportCatalog, ReportLibrary, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null">
            </ReportSource>
