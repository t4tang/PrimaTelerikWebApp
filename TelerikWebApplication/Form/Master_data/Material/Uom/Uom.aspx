<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Uom.aspx.cs" Inherits="TelerikWebApplication.Form.Master_data.Material.Uom.Uom" %>
        ...
        <!-- Page Content -->
             <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" runat="server" AllowPaging="True" ShowFooter="true" Skin="MetroTouch"
                ...
                <PagerStyle Mode="NextPrevNumericAndAdvanced"></PagerStyle>
                    <MasterTableView Width="100%" CommandItemDisplay="Top" DataKeyNames="unit_code" Font-Size="13px"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="unit_name" HeaderText="Unit Name" DataField="unit_name">
