<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="TelerikWebApplication.Form.Production.Reports.dashboard" %>
        ...
        <div style="padding-top:20px">
            <telerik:ReportViewer 
                ...
                <ReportSource
                    ...
                    Identifier="ReportLibrary.Reports.Production.ReportCatalog, ReportLibrary, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null">
                </ReportSource>
            </telerik:ReportViewer>
        </div>
