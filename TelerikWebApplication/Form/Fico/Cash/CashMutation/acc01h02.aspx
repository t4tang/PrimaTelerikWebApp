            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" runat="server" AllowPaging="True" ShowFooter="false" PageSize="14" Skin="Silk"
                ...
                CommandItemSettings-AddNewRecordText="New" EditFormSettings-EditFormType="Template" InsertItemDisplay="Top">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="NoCtrl" HeaderText="Ctrl. No" DataField="NoCtrl" FilterControlWidth="90px">
                            <HeaderStyle Width="90px" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="NoRef" HeaderText="Reg. No" DataField="NoRef" FilterControlWidth="90px">
                            <HeaderStyle Width="90px" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="KoTrans" HeaderText="Transaction" DataField="KoTrans" FilterControlWidth="100px">
                            <HeaderStyle Width="100px" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="KoKas" HeaderText="Cash Code" DataField="KoKas" FilterControlWidth="70px">
                            <HeaderStyle Width="70px" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="currency" HeaderText="Currency" DataField="cur_code" FilterControlWidth="50px">
                            <HeaderStyle Width="50px" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="kurs" HeaderText="Kurs" DataField="kurs" FilterControlWidth="90px">
                            <HeaderStyle Width="90px" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="amount" HeaderText="Amount" DataField="Total" FilterControlWidth="110px">
                            <HeaderStyle Width="110px" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="contact" HeaderText="Contact" DataField="Kontak" FilterControlWidth="90px">
                            <HeaderStyle Width="90px" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="keterangan" HeaderText="Remark" DataField="Ket" FilterControlWidth="330px" ItemStyle-Width="310px" ItemStyle-Wrap="true">
                    ...
                    <FormTemplate>
                        ...
                        <td style="vertical-align: top; padding-left:15px">
                            <table id="Table3" border="0" class="module">
                                <tr>
                                    ...
                                    <td style="vertical-align:top; text-align:left">                      
                                        <telerik:RadComboBox RenderMode="Lightweight" ID="cb_Project" runat="server" Width="300" DropDownWidth="300px"
                                            AutoPostBack="true" ShowMoreResultsBox="true" EmptyMessage="- Select a Project -" Skin="Telerik" CausesValidation ="false"  
                                ...
                                <tr>
                                    <td class="tdLabel">
                                        <telerik:RadLabel runat="server" Text="Cash:" CssClass="lbObject" ForeColor="Black"></telerik:RadLabel>
                                    </td>
                                    <td style="vertical-align:top; text-align:left">                  
                        ...
                        <td>
                           <table>
                               ...
                               <tr>
                                   <td>
                                       <telerik:RadLabel runat="server" Text="Aproval By:" CssClass="lbObject" ForeColor="Black"></telerik:RadLabel>
                                   </td>     
                                   <td>
                       ...
                       <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid2" runat="server" AllowPaging="False" ShowFooter="false" PageSize="5" Skin="Silk"
                           ...
                           <MasterTableView CommandItemDisplay="Top" DataKeyNames="NoBuk,KoRek" Font-Size="11px" EditMode="InPlace"
                               ...
                               <Columns>
                                   ...
                                   <telerik:GridTemplateColumn UniqueName="KoRek" HeaderText="Account No." ItemStyle-Width="100px" HeaderStyle-Width="100px" 
                                            SortExpression="KoRek" >
                                            <FooterTemplate>Template footer</FooterTemplate>
                                            <FooterStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                            <ItemTemplate>  
                                                <asp:Label ID="lbl_korek" Width="100px" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "KoRek")%>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>                                       
                                   ...
                                   <telerik:GridTemplateColumn HeaderText="Remark" ItemStyle-Width="300px"  HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="300px">
                                            <ItemTemplate>  
                                                <asp:Label ID="lbl_KetD" Width="300px" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Ket") %>' ></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_KetD" Width="300px"
                                                    Text='<%# DataBinder.Eval(Container, "DataItem.Ket") %>'>
                                                </telerik:RadTextBox>                                                 
                                            </EditItemTemplate>
                                            <InsertItemTemplate>
                                                <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_KetD_insert" Width="300px">
                                                </telerik:RadTextBox> 
                                            </InsertItemTemplate>
                                   </telerik:GridTemplateColumn>
                                   <telerik:GridTemplateColumn HeaderText="D/C" ItemStyle-Width="10px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                                            <ItemTemplate>  
                                                <asp:Label ID="lbl_mutasiD" Width="50px" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Mutasi")%>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_Mutasi" DropDownWidth="100px" AutoPostBack="false"    
                                                    EnableLoadOnDemand="true" Skin="Telerik" DataValueField="Mutasi" DataTextField="name" Width="50px" 
                                            ...
                                            <InsertItemTemplate>
                                                <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_Mutasi_insert" DropDownWidth="100px" Width="50px"   
                                                    EnableLoadOnDemand="true" Skin="Telerik" DataValueField="Mutasi" DataTextField="name" AutoPostBack="false"  
                                                    OnItemsRequested="cb_Mutasi_ItemsRequested" OnSelectedIndexChanged="cb_Mutasi_SelectedIndexChanged" OnPreRender="cb_Mutasi_PreRender">
                                                </telerik:RadComboBox>
                                            </InsertItemTemplate>
                                   </telerik:GridTemplateColumn>
                                   <telerik:GridTemplateColumn HeaderText="Kurs" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100px">
                                            <ItemTemplate>  
                                   ...
                                   <telerik:GridTemplateColumn UniqueName="region_code" HeaderText="Project" HeaderStyle-Width="180px"  HeaderStyle-HorizontalAlign="Center"
                                            SortExpression="region_code" ItemStyle-Width="180px" ItemStyle-HorizontalAlign="Center">
                                            <FooterTemplate>Template footer</FooterTemplate>
                                            <FooterStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_ProjectD" Width="180px" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.region_code") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>   
                                                <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_Project_Detail" DropDownWidth="350px" 
                                                    ...
                                                    OnSelectedIndexChanged="cb_Project_Detail_SelectedIndexChanged" OnPreRender="cb_Project_Detail_PreRender" Height="190px" Width="180px" 
                                                    AutoPostBack="True">
                                                    <HeaderTemplate>
                                   ...
                                   <telerik:GridTemplateColumn UniqueName="dept_code" HeaderText="Cost Center" HeaderStyle-Width="120px"  HeaderStyle-HorizontalAlign="Center"
                                            SortExpression="dept_code" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center">
                                            <FooterTemplate>Template footer</FooterTemplate>
                                            <FooterStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                            <ItemTemplate>  
                                                <asp:Label ID="lbl_CostCntrD" Width="120px" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "dept_code")%>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_Cost_Center" DropDownWidth="350px" AutoPostBack="false"  
                                                    EnableLoadOnDemand="True" Skin="Telerik" DataValueField="CostCenter" DataTextField="name" 
                                                    ...
                                                    OnPreRender="cb_Cost_Center_PreRender" Height="190px" Width="120px" >
                                                    <HeaderTemplate>
                                                        <table style="width: 350px; font-size:smaller">
                                                            <tr>
                                                                <td style="width: 100px;">
                                            ...
                                            <InsertItemTemplate>
                                                <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_Cost_Center_insert" DropDownWidth="180px" AutoPostBack="false"  
                                                    EnableLoadOnDemand="True" Skin="Telerik" DataValueField="CostCenter" DataTextField="name"  
