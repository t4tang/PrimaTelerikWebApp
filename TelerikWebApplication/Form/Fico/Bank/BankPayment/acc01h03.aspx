...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
     ...
     <telerik:RadAjaxLoadingPanel ID="gridLoadingPanel" runat="server" MinDisplayTime="2500" BackgroundPosition="None">
        <img alt="Loading..." src="../../../../Images/loading.gif" style="top: 40px" />
                ...
                <td style="vertical-align:top; width:35%">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_slip_number" runat="server" Width="150px" ReadOnly="true" RenderMode="Lightweight"
                                        AutoPostBack="false">
                                    </telerik:RadTextBox>
                                        &nbsp;
                ...
                <td>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_user" runat="server" Width="50px" RenderMode="Lightweight"
                                        AutoPostBack="false" ReadOnly="true">
                                    </telerik:RadTextBox>
                                    &nbsp;&nbsp;&nbsp;Last Update :  
                                    <telerik:RadTextBox ID="txt_lastupdate" runat="server" Width="160px" RenderMode="Lightweight"
                                        AutoPostBack="false" ReadOnly="true">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
        ...
        <%--DETAIL--%>
            <div style=" width:100%; border-top-color: #336600; border-top-width: 1px; border-top-style: inset; padding-top: 20px;">
                <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid2" GridLines="None" AutoGenerateColumns="false" PageSize="5"
                    ...
                    OnNeedDataSource="RadGrid2_NeedDataSource" OnInsertCommand="RadGrid2_save_handler">   
                        <MasterTableView CommandItemDisplay="Top" Font-Size="12px" EditMode="InPlace"
                            ...
                            <Columns>
                                <telerik:GridEditCommandColumn FooterText="EditCommand footer" UniqueName="EditCommandColumn"
                                    HeaderText="Edit" HeaderStyle-Width="80px" UpdateText="Update">
                                </telerik:GridEditCommandColumn>      
                                <telerik:GridTemplateColumn UniqueName="inv_code" HeaderText="Reg. Number" HeaderStyle-Width="150px"
                                    DataField="inv_code" SortExpression="inv_code" ItemStyle-Width="150px">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lbl_NoBuk" Text='<%# Eval("inv_code") %>'></asp:Label> 
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                    <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_NoBuk" EnableLoadOnDemand="True" DataTextField="NoBuk"
                                        DataValueField="NoBuk" AutoPostBack="true" HighlightTemplatedItems="true" Height="190px" Width="150px" DropDownWidth="380px"
                                ...
                                <telerik:GridTemplateColumn HeaderText="Inv Number" ItemStyle-Width="120px" DataField="inv_code">
                                    <ItemTemplate>  
                                        <asp:Label runat="server" ID="lbl_inv_code" Text='<%# Eval("inv_code") %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridTemplateColumn HeaderText="Inv Date" ItemStyle-Width="120px" DataField="slip_date">
                                    <ItemTemplate>  
                                        <asp:Label runat="server" ID="lbl_slip_date" Text='<%# Eval("slip_date","{0:dd-MM-yyyy}") %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                               <telerik:GridTemplateColumn HeaderText="Remark" ItemStyle-Width="250px" DataField="remark">
                                    <ItemTemplate>  
                                ...
                                <telerik:GridTemplateColumn HeaderText="Amount" ItemStyle-Width="130px" ItemStyle-HorizontalAlign="Right"
                                    ...
                                    <EditItemTemplate>
                                        <telerik:RadTextBox  RenderMode="Lightweight" runat="server" ID="txt_amount" Width="150px"
                                ...
                                <telerik:GridTemplateColumn HeaderText="Project" ItemStyle-Width="80px" DataField="region_code">
                                    <ItemTemplate>  
                                        <asp:Label runat="server" ID="lbl_project_detail" Text='<%# Eval("region_code") %>'></asp:Label>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn> 
                                 <telerik:GridTemplateColumn HeaderText="Cost Center" ItemStyle-Width="80px" DataField="dept_code">
                                    <ItemTemplate>  
                                        <asp:Label runat="server" ID="lbl_cost_ctr" Text='<%# Eval("dept_code") %>'></asp:Label>
                                    </ItemTemplate>                                    
                                </telerik:GridTemplateColumn>  
