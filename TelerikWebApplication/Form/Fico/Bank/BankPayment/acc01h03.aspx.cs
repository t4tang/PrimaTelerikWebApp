    ...
    public partial class acc01h03 : System.Web.UI.Page
    {
        ...
        protected void RadGrid2_save_handler(object sender, GridCommandEventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@pay_amount", (item.FindControl("txt_kurs") as RadTextBox).Text);
                cmd.Parameters.AddWithValue("@remark", (item.FindControl("txt_Jumlah") as RadTextBox).Text);
                cmd.Parameters.AddWithValue("@selisih_kurs", (item.FindControl("cb_mutasi") as RadTextBox).Text);
                cmd.Parameters.AddWithValue("@pay_amount_acc", Convert.ToDouble((item.FindControl("txt_Ket") as RadTextBox).Text));
                cmd.Parameters.AddWithValue("@pay_amount_idr", Convert.ToDouble((item.FindControl("cb_cost_center") as RadTextBox).Text));
