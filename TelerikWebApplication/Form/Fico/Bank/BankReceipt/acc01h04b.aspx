                ...
                <MasterTableView Width="100%" CommandItemDisplay="Top" DataKeyNames="slip_no" Font-Size="11px" Font-Names="Century Gothic"
                    ...
                    <Columns>
                        <telerik:GridEditCommandColumn UniqueName="EditCommandColumn">
                            ...
                            <telerik:GridBoundColumn UniqueName="tot_pay" HeaderText="Tot Amount" DataField="tot_pay" DataFormatString='{0:#,###,###0.00}' ItemStyle-HorizontalAlign="Right" 
                                FilterControlWidth="90px" >
                                <HeaderStyle Width="90px"></HeaderStyle>
                            </telerik:GridBoundColumn>
                                   
                            <telerik:GridBoundColumn UniqueName="kurs" HeaderText="Kurs" DataField="kurs" DataFormatString='{0:#,###0.00000000}' ItemStyle-HorizontalAlign="Right" 
                                FilterControlWidth="70px" >
                                <HeaderStyle Width="70px"></HeaderStyle>
                            </telerik:GridBoundColumn>
                       
                            <telerik:GridBoundColumn UniqueName="cur_code" HeaderText="Curr." DataField="cur_code" ItemStyle-HorizontalAlign="Center" 
                            ...
                            <div style="padding: 15px 0px 0px 25px;">
                                <table id="Table1" border="0" style="border-collapse: collapse; padding:15px 0px 5px 0px; font-size:11px;">
                                    <tr style="vertical-align: top;">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td style="vertical-align:top; text-align:left">                      
                                                        <telerik:RadComboBox RenderMode="Lightweight" ID="cb_Cust" runat="server" Width="300" DropDownWidth="300px" Skin="Telerik"
                                                            ...
                                                            AutoPostBack="true" ShowMoreResultsBox="true" EnableLoadOnDemand ="true" 
                                        ...
                                        <td colspan="4" style="vertical-align: top; padding-left:25px" >
                                            <table>
                                                <tr>
                                                    <td style="width:90px">
                                                        Prepared By:
                                ...
                                <div style="padding: 7px 0px 12px 0px; height:350px">
                                        ...
                                        <telerik:RadPageView runat="server" ID="RadPageView1" Height="300px">
                                            <div runat="server" style="padding:10px 10px 10px 10px">
                                                <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid2" runat="server" AllowPaging="False" ShowFooter="false" PageSize="5" Skin="Silk"
                                                    ...
                                                    <MasterTableView CommandItemDisplay="Top" Font-Size="12px" EditMode="PopUp"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <telerik:GridTemplateColumn UniqueName="inv_code" HeaderText="Invoice No." HeaderStyle-Width="120px"
                                                                SortExpression="inv_code" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                <FooterTemplate>Template footer</FooterTemplate>
                                                                <FooterStyle VerticalAlign="Middle" HorizontalAlign="Center" />
                                                                <ItemTemplate>
                                                                    <%--<asp:Label runat="server" ID="lbl_inv_code" Text='<%#DataBinder.Eval(Container.DataItem, "inv_code")%>' Width="120px"></asp:Label>--%>
                                                                    <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_inv_code" EnableLoadOnDemand="True" DataTextField="JmlSisa"
                                                                        ...
                                                                        HighlightTemplatedItems="true" Height="290px" Width="120px" DropDownWidth="250px"
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Inv Date" ItemStyle-Width="110px" HeaderStyle-Width="110px" ItemStyle-HorizontalAlign="Center"
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Payment" ItemStyle-Width="120px" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>  
                                                                    <%--<asp:Label runat="server" ID="lbl_payment" Text='<%#DataBinder.Eval(Container.DataItem, "pay_amount", "{0:#,###,###0.00}")%>' Width="150px"></asp:Label>--%>
                                                                    <telerik:RadNumericTextBox  RenderMode="Lightweight" runat="server" ID="txt_payment" Width="120px" ItemStyle-HorizontalAlign="Right" 
                                                                        ...
                                                                        DbValue='<%# DataBinder.Eval(Container.DataItem, "pay_amount", "{0:#,###,###0.00}") %>'>
                                                                    </telerik:RadNumericTextBox>
                                                                </ItemTemplate>
                                                               <%-- <EditItemTemplate>
                                                                ...
                                                                <InsertItemTemplate>
                                                                    <telerik:RadNumericTextBox RenderMode="Lightweight" runat="server" ID="txt_payment_insert" Width="120px" ItemStyle-HorizontalAlign="Right" 
                                                                        NumberFormat-AllowRounding="true" onkeydown="blurTextBox(this, event)" NumberFormat-KeepNotRoundedValue="true" 
                                                                        AllowOutOfRangeAutoCorrect="false" AutoPostBack="true" MaxLength="11" Type="Number" NumberFormat-DecimalDigits="2" Skin="Telerik">
                                                                    </telerik:RadNumericTextBox>
                                                                </InsertItemTemplate>
                                                           ...
                                                           <%-- <telerik:GridTemplateColumn HeaderText="Intrst.(%)" ItemStyle-Width="200px">
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Kurs" ItemStyle-Width="90px" HeaderStyle-Width="90px" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>  
                                                                   <%-- <asp:Label runat="server" ID="lbl_kurs" Text='<%#DataBinder.Eval(Container.DataItem, "kurs","{0:#,###,###0.00000000}")%>' Width="90px">

                                                                    </asp:Label>
                                                                --%>
                                                                    <telerik:RadNumericTextBox ID="txt_kurs_detail" runat="server"  Width="90px" NumberFormat-AllowRounding="true"
                                                                ...
                                                                <InsertItemTemplate>
                                                                    <telerik:RadNumericTextBox ID="txt_kurs_detail_insert" runat="server"  Width="90px" NumberFormat-AllowRounding="true"
                                                                        NumberFormat-KeepNotRoundedValue="true" AllowOutOfRangeAutoCorrect="false" EnabledStyle-HorizontalAlign="Right" 
                                                                        onkeydown="blurTextBox(this, event)" MaxLength="11" Type="Number" NumberFormat-DecimalDigits="9">
                                                                    </telerik:RadNumericTextBox>
                                                                </InsertItemTemplate>
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Kurs Tax" ItemStyle-Width="90px" HeaderStyle-Width="90px" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>  
                                                                   <%-- <asp:Label runat="server" ID="lbl_kurs_tax" Text='<%#DataBinder.Eval(Container.DataItem, "kurs_tax","{0:#,###,###0.00000000}")%>' 
                                                                        Width="90px"></asp:Label>--%>
                                                                
                                                                    <telerik:RadNumericTextBox ID="txt_kurs_tax_detail" runat="server"  Width="90px" NumberFormat-AllowRounding="true"
                                                                        NumberFormat-KeepNotRoundedValue="true" AllowOutOfRangeAutoCorrect="false" EnabledStyle-HorizontalAlign="Right"
                                                                ...
                                                                <InsertItemTemplate>
                                                                    <telerik:RadNumericTextBox ID="txt_kurs_tax_detail_insert" runat="server"  Width="90px" NumberFormat-AllowRounding="true"
                                                                        NumberFormat-KeepNotRoundedValue="true" AllowOutOfRangeAutoCorrect="false" EnabledStyle-HorizontalAlign="Right" 
                                                                        onkeydown="blurTextBox(this, event)"  MaxLength="11" Type="Number" NumberFormat-DecimalDigits="9">
                                                                    </telerik:RadNumericTextBox>
                                                                </InsertItemTemplate>
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Project" ItemStyle-Width="70px" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>  
                                                                    <asp:Label runat="server" ID="lbl_project" Text='<%#DataBinder.Eval(Container.DataItem, "region_code")%>' Width="70px"></asp:Label>
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_project" Width="70px"
                                                                        Text='<%# DataBinder.Eval(Container, "DataItem.region_code") %>'>
                                                                    </telerik:RadTextBox>
                                                                </EditItemTemplate>
                                                                <InsertItemTemplate>
                                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_project_insert" Width="70px">
                                                                    </telerik:RadTextBox>
                                                                </InsertItemTemplate>
                                                            </telerik:GridTemplateColumn> 

                                                            <telerik:GridTemplateColumn HeaderText="Cost ctr." HeaderStyle-Width="100px" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Center"
                                                                HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>  
                                                                    <asp:Label runat="server" ID="lbl_cost_ctr" Text='<%#DataBinder.Eval(Container.DataItem, "dept_code")%>' Width="70px"></asp:Label>
                                                                </ItemTemplate>
                                                                <EditItemTemplate>
                                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_cost_ctr" Width="70px"
                                                                        Text='<%# DataBinder.Eval(Container, "DataItem.dept_code") %>'>
                                                                    </telerik:RadTextBox>
                                                                </EditItemTemplate>
                                                                <InsertItemTemplate>
                                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_cost_ctr_insert" Width="70px">
                                                                    </telerik:RadTextBox>
                                                                </InsertItemTemplate>
                                                            </telerik:GridTemplateColumn> 

                                                            <telerik:GridTemplateColumn HeaderText="Remark" ItemStyle-Width="180px" HeaderStyle-Width="180px" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>  
                                                                    <%--<asp:Label runat="server" ID="lbl_ket" Text='<%#DataBinder.Eval(Container.DataItem, "remark")%>' Width="180px"></asp:Label>--%>
                                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_Ket" Width="180px"
                                                                ...
                                                                <InsertItemTemplate>
                                                                    <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_Ket_insert" Width="180px">
                                                                    </telerik:RadTextBox>
                                                                </InsertItemTemplate>
                                                            </telerik:GridTemplateColumn> 
