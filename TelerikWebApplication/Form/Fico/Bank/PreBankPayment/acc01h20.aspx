<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="acc01h20.aspx.cs" Inherits="TelerikWebApplication.Form.Fico.Bank.PreBankPayment.acc01h20" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel2" runat="server" MinDisplayTime="2500" BackgroundPosition="None" Skin="Material">
        <img alt="Loading..." src="../../../../Images/loading.gif" style="border: 0px; width:60px; height:45px; position: absolute; top: 100px; left:600px" />
    </telerik:RadAjaxLoadingPanel>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>    
                                                        ...
                                                        <telerik:RadNumericTextBox ID="txt_kurs" runat="server" Width="111px" ReadOnly="true" RenderMode="Lightweight" 
                                                            Skin="Telerik"  DbValue='<%# DataBinder.Eval(Container, "DataItem.kurs", "{0:#,###0.00}" ) %>' NumberFormat-DecimalDigits="9" NumberFormat-DecimalSeparator=".">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadNumericTextBox ID="txt_kurs2" runat="server" Width="111px" ReadOnly="true" RenderMode="Lightweight" Skin="Telerik" 
                                                            DbValue='<%# DataBinder.Eval(Container, "DataItem.kurs_acc", "{0:#,###0.00}" ) %>' NumberFormat-DecimalDigits="9" NumberFormat-DecimalSeparator="." >
                                                            <EmptyMessageStyle CssClass="MyEmptyTextBox"></EmptyMessageStyle>
                                                            <EnabledStyle CssClass="MyEnabledTextBox"></EnabledStyle>
                                                            <FocusedStyle CssClass="MyFocusedTextBox"></FocusedStyle>
                                                            <HoveredStyle CssClass="MyHoveredTextBox"></HoveredStyle>
                                        ...
                                        <td style="vertical-align: top; padding-left:45px">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td >                      
                                                        <telerik:RadComboBox RenderMode="Lightweight" ID="cb_pre" runat="server" Width="300" Height="300px" DropDownWidth="300px"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadComboBox RenderMode="Lightweight" ID="cb_check" runat="server" Width="300" Height="300px" DropDownWidth="300px"
                                                            AutoPostBack="false" ShowMoreResultsBox="true" EmptyMessage="- Select -" EnableLoadOnDemand="True" Skin="Telerik" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadComboBox RenderMode="Lightweight" ID="cb_approve" runat="server" Width="300" Height="300px" DropDownWidth="300px"
                                                            AutoPostBack="false" ShowMoreResultsBox="true" EmptyMessage="- Select -" EnableLoadOnDemand="True" Skin="Telerik" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:70px;">
                                                        <telerik:RadTextBox ReadOnly="true" ID="txt_lastUpdate" Width="100px" runat="server" Skin="Silk" ReadOnlyStyle-HorizontalAlign="Center"
                                                            Text='<%# DataBinder.Eval(Container, "DataItem.lastupdate","{0:dd-MM-yyyy}") %>'>
                                                        </telerik:RadTextBox>
                                                    </td>
                                    ...
                                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid2" runat="server" AllowPaging="False" ShowFooter="false" PageSize="5" Skin="Silk"
                                        ...
                                        <MasterTableView CommandItemDisplay="Top" Font-Size="12px" EditMode="PopUp"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Inv Number" ItemStyle-Width="100px" HeaderStyle-Width="150px" DataField="inv_code">
                                                    <ItemTemplate>  
                                                    ...
                                                    <InsertItemTemplate>
                                                        <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txt_invCode_insert" Width="150px" ReadOnly="true">
                                                        </telerik:RadTextBox>
                                                    </InsertItemTemplate>
                                                </telerik:GridTemplateColumn>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Inv Date" ItemStyle-Width="120px" HeaderStyle-Width="120px" DataField="slip_date">
                                                    ...
                                                    <InsertItemTemplate>
                                                        <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="dtp_InvDate_insert" Width="120px" ReadOnly="true">
                                                        </telerik:RadTextBox>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Project" ItemStyle-Width="60px" HeaderStyle-Width="60px" DataField="region_code" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>  
                                                        <asp:Label runat="server" ID="lbl_project_detail" Width="60px" Text='<%# Eval("region_code") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <%--<EditItemTemplate>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Cost Cntr" ItemStyle-Width="80px" HeaderStyle-Width="80px" DataField="dept_code">
                                                    <ItemTemplate>  
                                                        <asp:Label runat="server" ID="lbl_cost_ctr" Text='<%# Eval("dept_code") %>' Width="80px"></asp:Label>
                                                    </ItemTemplate>
                                                    <%--<EditItemTemplate>
                                                    ...
                                                    <InsertItemTemplate>
                                                        <telerik:RadTextBox runat="server" RenderMode="Lightweight" ID="txt_CostCenter_insert" Width="80px" ReadOnly="true"></telerik:RadTextBox>
                                                    </InsertItemTemplate>                                   
                                                </telerik:GridTemplateColumn> 
