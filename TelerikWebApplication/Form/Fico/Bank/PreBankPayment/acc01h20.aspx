        ...
        <table id="tbl_control">
            <tr>
                ...
                <td style="width: 86%; text-align: right">
                    <telerik:RadLabel ID="RadLabel1" runat="server" Text="PreBank Payment Voucher" 
        ...
        <%--DETAIL--%>
            <div style=" width:100%; border-top-color: #336600; border-top-width: 1px; border-top-style: inset; padding-top: 20px;">
             ...
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DbConString %>"
                    SelectCommand="SELECT * FROM v_prebank_paymentD WHERE slip_no = @slipno"                    
                    DeleteCommand="DELETE FROM acc01d20 WHERE slip_no = @slipno AND inv_code = @inv_code">
                   <SelectParameters>
