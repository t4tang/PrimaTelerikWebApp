<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="acc01h01.aspx.cs" Inherits="TelerikWebApplication.Form.Fico.Bank.BankMutation.acc01h01" %>
                                        ...
                                        <telerik:RadPageView runat="server" ID="RadPageView1" Height="300px">
                                            <div runat="server" style="padding:10px 10px 10px 10px">
                                                <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid2" runat="server" AllowPaging="False" ShowFooter="false" PageSize="5" Skin="Silk"
                                                    ...
                                                    <MasterTableView DataKeyNames="NoBuk, KoRek, Nomor" CommandItemDisplay="Top" Font-Size="12px" EditMode="PopUp"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <telerik:GridTemplateColumn UniqueName="KoRek" HeaderText="Account No." HeaderStyle-Width="110px"
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <telerik:RadComboBox RenderMode="Lightweight" runat="server" ID="cb_korek" EnableLoadOnDemand="True" DataTextField="accountname"
                                                                        OnItemsRequested="cb_korek_ItemsRequested" DataValueField="KoRek" AutoPostBack="false"
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Kurs" ItemStyle-Width="100px" HeaderStyle-Width="100px" Visible="false"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>  
                                                                    <%--<asp:Label ID="lbl_KursD" Width="100px" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.kurs","{0:#,###,##0.0000}") %>' ></asp:Label>--%>
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Ammount" ItemStyle-Width="150px" HeaderStyle-Width="150px" 
                                                                ...
                                                                <ItemTemplate>  
                                                                    ...
                                                                    <telerik:RadNumericTextBox RenderMode="Lightweight" runat="server" ID="txt_Jumlah" Width="150px" 
                                                                        NumberFormat-AllowRounding="true" onkeydown="blurTextBox(this, event)" NumberFormat-KeepNotRoundedValue="true" 
                                                                        AllowOutOfRangeAutoCorrect="false" AutoPostBack="false" MaxLength="11" Type="Number" Skin="Telerik"
                                                                        DbValue='<%# DataBinder.Eval(Container, "DataItem.Jumlah","{0:#,###,###0.00}") %>'>
                                                                    </telerik:RadNumericTextBox>
                                                                </ItemTemplate>
                                                                <InsertItemTemplate>
                                                                    <telerik:RadNumericTextBox RenderMode="Lightweight" runat="server" ID="txt_Jumlah_insert" Width="150px" ItemStyle-HorizontalAlign="Right" 
                                                                        NumberFormat-AllowRounding="true" onkeydown="blurTextBox(this, event)" NumberFormat-KeepNotRoundedValue="true" 
                                                                        AllowOutOfRangeAutoCorrect="false" AutoPostBack="true" MaxLength="11" Type="Number" NumberFormat-DecimalDigits="2" Skin="Telerik"></telerik:RadNumericTextBox>
                                                                </InsertItemTemplate>
                                                            </telerik:GridTemplateColumn>
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="Nomor" ItemStyle-Width="10px" HeaderStyle-Width="10px" Visible="false"  ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>  
                                                                    <%--<asp:Label ID="lbl_nomor" Width="10px" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Nomor") %>' ></asp:Label>--%>
                                                                    <telerik:RadNumericTextBox RenderMode="Lightweight" runat="server" ID="txt_nomor" Width="150px" BorderStyle="None" 
                                                                        NumberFormat-AllowRounding="true" onkeydown="blurTextBox(this, event)" NumberFormat-KeepNotRoundedValue="true" 
                                                                        AllowOutOfRangeAutoCorrect="false" AutoPostBack="false" MaxLength="11" Type="Number" Skin="Telerik"
                                                                        DbValue='<%# DataBinder.Eval(Container, "DataItem.Nomor") %>'>
                                                                    </telerik:RadNumericTextBox>
                                                                </ItemTemplate>
                                                                <InsertItemTemplate>
                                                                    <telerik:RadNumericTextBox RenderMode="Lightweight" runat="server" ID="txt_nomor_insert" Width="150px" BorderStyle="None" 
                                                                        NumberFormat-AllowRounding="true" onkeydown="blurTextBox(this, event)" NumberFormat-KeepNotRoundedValue="true" Visible="false" 
                                                                        AllowOutOfRangeAutoCorrect="false" AutoPostBack="false" MaxLength="11" Type="Number" Skin="Telerik">
                                                                    </telerik:RadNumericTextBox>
                                                                </InsertItemTemplate>
                                                            
                                                            </telerik:GridTemplateColumn>
                                                            <telerik:GridButtonColumn UniqueName="DeleteColumn" Text="Del" CommandName="Delete" ConfirmText="Data akan langsung dihapus di database. Yakin akan menghapusnya?" 
