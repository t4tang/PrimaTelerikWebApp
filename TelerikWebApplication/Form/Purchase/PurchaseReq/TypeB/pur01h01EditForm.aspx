                 ...
                 <asp:UpdatePanel ID="panel2" runat="server" UpdateMode="Always">
                      <ContentTemplate>
                            ...
                            AllowPaging="false" PageSize="5" AllowSorting="true" runat="server" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" 
                                ...
                                <HeaderStyle CssClass="gridHeader"  BackColor="#c0c0c0" ForeColor="WindowText" Font-Size="12px" BorderStyle="Groove" BorderColor="YellowGreen" />
                                ...
                                CommandItemSettings-ShowRefreshButton="False" ItemStyle-ForeColor="#006600">
                                    ...
                                    <Columns>
                                        <telerik:GridTemplateColumn HeaderText="Type" ItemStyle-Width="50px" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center" 
                                            ...
                                            <ItemTemplate>
                                                <asp:Label runat="server" Width="50px" ID="lblProdType" Text='<%# DataBinder.Eval(Container.DataItem, "prod_type") %>'></asp:Label>                                           
                                            </ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Remark" HeaderStyle-Width="450px" ItemStyle-Width="450px"
                                            HeaderStyle-BackColor="#3399cc" HeaderStyle-ForeColor="Highlight" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <telerik:RadTextBox RenderMode="Lightweight" runat="server" ID="txtRemark_d" Width="450px"
                                ...
                                <ClientSettings >
                                    <Scrolling AllowScroll="true" UseStaticHeaders="true" ScrollHeight="263px" />  
