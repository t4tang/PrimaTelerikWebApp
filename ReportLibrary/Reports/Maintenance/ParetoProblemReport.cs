namespace ReportLibrary.Reports.Maintenance
{
    ...
    /// <summary>
    /// Summary description for ParetoProblemReport.
    /// </summary>
    /// 
    [Description("Display Work Order or User Request status in a given periode")]

    public partial class ParetoProblemReport : Telerik.Reporting.Report
    {
        ...
        //public static DateTime _firstDate;
        //public static DateTime _endDate;

        public ParetoProblemReport()
        {
            //
            ...
            sqlParetoProblem.Parameters[1].Value = "=Parameters.tglawal.Value";
            sqlParetoProblem.Parameters[2].Value = "=Parameters.tglakhir.Value";
            sqlParetoProblem.Parameters[0].Value = "=Parameters.project.Value";
        }
    }
}