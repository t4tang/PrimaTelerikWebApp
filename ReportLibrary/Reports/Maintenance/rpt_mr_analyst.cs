namespace ReportLibrary.Reports.Maintenance
{
    ...
    /// <summary>
    /// Summary description for rpt_mr_analyst.
    /// </summary>
    public partial class MaterialRequestAnalyst : Telerik.Reporting.Report
    {
        ...
        public MaterialRequestAnalyst()
        {
            ...
            param2.Value = "2019-10-01"/*string.Format("{0:yyyy-MM-dd}", _tglawal)*/;
            param2.Visible = true;
            ...
            param3.Value = "2019-10-01"/*string.Format("{0:yyyy-MM-dd}", _tglakhir)*/;
            param3.Visible = true;
