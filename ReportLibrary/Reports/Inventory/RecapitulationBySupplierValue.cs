namespace ReportLibrary.Reports.Inventory
{
    ...
    /// <summary>
    /// Summary description for RecapitulationBySupplierValue.
    /// </summary>
    /// 
    [Description("Display Work Order or User Request status in a given periode")]

    public partial class RecapitulationBySupplierValue : Telerik.Reporting.Report
    {
        ...
        public RecapitulationBySupplierValue()
        {
            //
