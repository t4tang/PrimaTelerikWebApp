namespace ReportLibrary.Reports.Inventory
{
    ...
    /// <summary>
    /// Summary description for RecapitulationByGRNumberValue.
    /// </summary>
    /// 
    [Description("Display Work Order or User Request status in a given periode")]

    public partial class RecapitulationByGRNumberValue : Telerik.Reporting.Report
    {
        ...
        public RecapitulationByGRNumberValue()
        {
            //
