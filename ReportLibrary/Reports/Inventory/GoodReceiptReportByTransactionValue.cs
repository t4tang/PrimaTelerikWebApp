namespace ReportLibrary.Reports.Inventory
{
    ...
    /// <summary>
    /// Summary description for GoodReceiptReportByTransactionValue.
    /// </summary>
    /// 
    [Description("Display Work Order or User Request status in a given periode")]
    public partial class GoodReceiptReportByTransactionValue : Telerik.Reporting.Report
    {
        ...
        public GoodReceiptReportByTransactionValue()
        {
            //
            ...
            sqlGoodReceiptByValue.Parameters[1].Value = "=Parameters.tglawal.Value";
            sqlGoodReceiptByValue.Parameters[2].Value = "=Parameters.tglakhir.Value";
            sqlGoodReceiptByValue.Parameters[0].Value = "=Parameters.project.Value";
        }
    }
}