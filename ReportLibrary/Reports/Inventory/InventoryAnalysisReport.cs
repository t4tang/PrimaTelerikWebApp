namespace ReportLibrary.Reports.Inventory
{
    ...
    /// <summary>
    /// Summary description for InventoryAnalysisReport.
    /// </summary>
    /// 
    [Description("Display Work Order or User Request status in a given periode")]

    public partial class InventoryAnalysisReport : Telerik.Reporting.Report
    {
        ...
        public InventoryAnalysisReport()
        {
            //
            ...
            sqlInventoryAnalysisReport.Parameters[1].Value = "=Parameters.tglawal.Value";
            sqlInventoryAnalysisReport.Parameters[2].Value = "=Parameters.tglakhir.Value";
            sqlInventoryAnalysisReport.Parameters[0].Value = "=Parameters.project.Value";
        }
    }
}