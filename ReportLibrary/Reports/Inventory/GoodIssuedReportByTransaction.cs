namespace ReportLibrary.Reports.Inventory
{
    ...
    /// <summary>
    /// Summary description for GoodIssuedReportByTransaction.
    /// </summary>
    /// 
    [Description("Display Work Order or User Request status in a given periode")]

    public partial class GoodIssuedReportByTransaction : Telerik.Reporting.Report
    {
        ...
        public GoodIssuedReportByTransaction()
        {
            //
