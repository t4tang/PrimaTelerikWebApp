namespace ReportLibrary.Reports.Inventory
{
    ...
    public partial class PurchaseRequestToGoodsReceiveReport : Telerik.Reporting.Report
    {
        ...
        public PurchaseRequestToGoodsReceiveReport()
        {
            ...
            sqlDataSourcePR2GR.Parameters[0].Value = "=Parameters.project.Value";
            sqlDataSourcePR2GR.Parameters[1].Value = "=Parameters.tglawal.Value";
            sqlDataSourcePR2GR.Parameters[2].Value = "=Parameters.tglakhir.Value";
        }
    }
}