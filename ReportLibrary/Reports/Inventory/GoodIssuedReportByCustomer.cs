namespace ReportLibrary.Reports.Inventory
{
    ...
    /// <summary>
    /// Summary description for GoodIssuedReportByCustomer.
    /// </summary>
    /// 
    [Description("Display Work Order or User Request status in a given periode")]

    public partial class GoodIssuedReportByCustomer : Telerik.Reporting.Report
    {
        ...
        public GoodIssuedReportByCustomer()
        {
            //
