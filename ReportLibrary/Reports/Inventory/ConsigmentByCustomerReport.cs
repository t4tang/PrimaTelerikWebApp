namespace ReportLibrary.Reports.Inventory
{
    ...
    /// <summary>
    /// Summary description for ConsigmentByCustomerReport.
    /// </summary>
    /// 
    [Description("Display Work Order or User Request status in a given periode")]

    public partial class ConsigmentByCustomerReport : Telerik.Reporting.Report
    {
        ...
        public ConsigmentByCustomerReport()
        {
            //
            ...
            sqlGoodIssuedConsigmentByCustomerReport.Parameters[1].Value = "=Parameters.tglawal.Value";
            sqlGoodIssuedConsigmentByCustomerReport.Parameters[2].Value = "=Parameters.tglakhir.Value";
            sqlGoodIssuedConsigmentByCustomerReport.Parameters[0].Value = "=Parameters.project.Value";
        }
    }
}