namespace ReportLibrary.Reports.Inventory
{
    ...
    /// <summary>
    /// Summary description for GoodIssuedWithMapByValueReport.
    /// </summary>
    /// 
    [Description("Display Work Order or User Request status in a given periode")]
    public partial class GoodIssuedWithMapByValueReport : Telerik.Reporting.Report
    {
        ...
        public GoodIssuedWithMapByValueReport()
        {
            //
