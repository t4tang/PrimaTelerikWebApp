namespace ReportLibrary.Reports.Inventory
{
    ...
    /// <summary>
    /// Summary description for Good_Receipt_Report_By_Supplier.
    /// </summary>
    /// 
    ...
    public partial class Good_Receipt_Report_By_Supplier : Telerik.Reporting.Report
    {
        ...
        public Good_Receipt_Report_By_Supplier()
        {
            ...
            GoodReceiptReportGroupBySupplier.Parameters[1].Value = "=Parameters.tglawal.Value";
            GoodReceiptReportGroupBySupplier.Parameters[2].Value = "=Parameters.tglakhir.Value";
            GoodReceiptReportGroupBySupplier.Parameters[0].Value = "=Parameters.project.Value";
        }
    }
}