namespace ReportLibrary.Reports.Purchase
{
    ...
    /// <summary>
    /// Summary description for rpt_PO_Remaining_ByProduct_SubGroupByPONumber.
    /// </summary>
    public partial class rpt_PO_Remaining_ByProduct_SubGroupByPONumber : Telerik.Reporting.Report
    {
        ...
        public rpt_PO_Remaining_ByProduct_SubGroupByPONumber()
        {
            InitializeComponent();
