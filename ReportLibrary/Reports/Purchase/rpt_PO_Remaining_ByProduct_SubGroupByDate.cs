namespace ReportLibrary.Reports.Purchase
{
    ...
    /// <summary>
    /// Summary description for rpt_PO_Remaining_ByProduct_SubGroupByDate.
    /// </summary>
    public partial class rpt_PO_Remaining_ByProduct_SubGroupByDate : Telerik.Reporting.Report
    {
        ...
        public rpt_PO_Remaining_ByProduct_SubGroupByDate()
        {
            InitializeComponent();
