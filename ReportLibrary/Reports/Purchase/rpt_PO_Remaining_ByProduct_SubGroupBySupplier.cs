namespace ReportLibrary.Reports.Purchase
{
    ...
    /// <summary>
    /// Summary description for rpt_PO_Remaining_ByProduct_SubGroupBySupplier.
    /// </summary>
    public partial class rpt_PO_Remaining_ByProduct_SubGroupBySupplier : Telerik.Reporting.Report
    {
        ...
        public rpt_PO_Remaining_ByProduct_SubGroupBySupplier()
        {
            InitializeComponent();
